...
![Cấu hình các tham số S3 Bucket](/images/deploy1.jpg)

![Xác nhận cấp phát instance S3 Bucket trống ban đầu](/images/deploy2.jpg)
...
![Kiểm tra các đối tượng tĩnh đã tải lên trong S3 Bucket](/images/deploy3.jpg)
...
![Kiểm tra trang tổng quan cấu hình chung của CloudFront](/images/deploy4.jpg)
...
![Cấu hình phản hồi trang lỗi tùy chỉnh cho tính tương thích SPA](/images/deploy5.jpg)
...
![Thực hiện theo dõi tác vụ xóa bộ nhớ đệm Asset Cache Invalidation](/images/deploy6.png)
...
![Cập nhật ranh giới chuyển hướng Amazon Cognito App Client](/images/deploy7.png)
...
![Kiểm tra cấu hình đăng ký vùng Domain trong Route 53](/images/deploy8.jpg)
