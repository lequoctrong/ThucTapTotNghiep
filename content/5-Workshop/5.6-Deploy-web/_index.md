...
6. Wait until the status changes from `In progress` to `Completed`.
   ...
   ![Create a CloudFront Invalidation after updating the frontend](/ThucTapAWS/images/5-Workshop/5.6-deploy-web/deploy6.png)
...
8. Click **Save changes**.
   ...
   ![Update callback and sign-out URLs in Amazon Cognito](/ThucTapAWS/images/5-Workshop/5.6-deploy-web/deploy7.png)
